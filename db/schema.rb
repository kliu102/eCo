...
ActiveRecord::Schema.define(version: 20141006064429) do
  ...
  create_table "spree_vendor_links", force: true do |t|
    t.string   "name"
  ...
  add_index "spree_vendor_links", ["variant_id"], name: "index_spree_vendor_links_on_variant_id", using: :btree
